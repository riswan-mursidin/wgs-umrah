...
!(function (t, e, n, o) {
          ...
          (t === !0 ||
            ...
            ? (console.info("!!"),
              (e.timer = setTimeout(function () {
                console.info(
                  ">> " +
                    (e.instance.current.index +
                      (1 % e.instance.group.length) -
                      1)
                ),
                  e.instance.jumpTo(
  ...
  (function (t, e) {
    ...
    e.extend(!0, e.fancybox.defaults, {
      btnTpl: {
        share:
          '<button data-fancybox-share class="fancybox-button fancybox-button--share" title="{{SHARE}}"><svg viewBox="0 0 40 40"><path d="M6,30 C8,18 27,14 23,16 L23,10 L33,20 L23,29 L23,24 C14,24 7,28 6,30 Z"></svg></button>',
      },
      shareTpl:
      ...
      e(t).on("click", "[data-fancybox-share]", function () {
        ...
        t &&
          e.fancybox.open({
            src: t.translate(
              t,
              t.current.opts.shareTpl
                .replace(/\{\{src\}\}/g, encodeURI(t.current.src))
                .replace(/\{\{descr\}\}/g, encodeURI(t.current.caption || ""))
            ),
            type: "html",
